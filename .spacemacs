...
values."
  (setq-default
   ...
   '(yaml
     ...
     ;; dart
     (dart :variables
           dart-server-sdk-path "/Users/dmlzj/www/flutter/source/bin/cache/dart-sdk/"
           dart-server-enable-analysis-server t
           dart-server-format-on-save t
           )
     ;; (dart :variables dart-sdk-path "/Users/dmlzj/www/flutter/source/bin/cache/dart-sdk/" dart-enable-analysis-server t dart-format-on-save t)
     gtags
     ;; ----------------------------------------------------------------
   ...
   dotspacemacs-additional-packages '(
                                      (quickrun :location(recipe
                                                          :fetcher github
                                                          :repo "syohex/emacs-quickrun"))
                                      (reveal-in-osx-finder :location (recipe
                                                                       :fetcher github
...
you should place your code here."
  ...
  ;; 平分窗口一样大小
  (global-set-key [(meta f4)] 'balance-windows)
  ...
  (global-set-key [(control f7)] 'helm-quickrun)

  ;; 透明度设置 MAC全屏状态没效果，你懂得
  ;;set transparent effect
  (global-set-key [(control f12)] 'loop-alpha)
  ...
  (global-set-key (kbd "C-M-\\") 'indent-region-or-buffer) ;绑定缩进快捷键
  ...
  ;; magit配置快捷键
  ;; 快速切换分支
  (global-set-key (kbd "M-m g c") 'magit-checkout)
  ;; 快速切换并创建分支
  (global-set-key (kbd "M-m g n") 'magit-branch-and-checkout)
  ;; 快速commit
  (global-set-key (kbd "M-m g a") 'magit-commit)
  ;; 快速push
  (global-set-key (kbd "M-m g g") 'magit-push)
  ;; 快速pull
  (global-set-key (kbd "M-m g p") 'magit-pull)
  ;; 快速merge
  (global-set-key (kbd "M-m g e") 'magit-merge)
  ;; 快速查看log
  (global-set-key (kbd "M-m g o") 'magit-log)
  ;; 快速查看所有的log-all
  (global-set-key (kbd "M-m g O") 'magit-log-all)
  ;; 快速查看diff
  (global-set-key (kbd "M-m g d") 'magit-diff)

  ;; 标准代码注释
  (add-to-list 'load-path "~/.emacs.d/elpa/doxymacs/")
  (require 'doxymacs)
  (global-set-key (kbd "C-c d f") 'doxymacs-insert-function-comment)
  (global-set-key (kbd "C-c d m") 'doxymacs-insert-blank-multiline-comment)
...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(package-selected-packages
     (quote
      (dart-server web-beautify livid-mode skewer-mode simple-httpd json-mode json-snatcher json-reformat js2-refactor multiple-cursors helm-gtags ggtags js2-mode js-doc company-tern dash-functional tern coffee-mode phpunit phpcbf php-extras php-auto-yasnippets drupal-mode php-mode evil-magit unfill smeargle orgit org-projectile org-category-capture org-present org-pomodoro alert log4e gntp org-mime org-download mwim markdown-toc markdown-mode magit-gitflow magit-popup htmlize helm-gitignore helm-company helm-c-yasnippet gnuplot gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link gh-md fuzzy magit transient git-commit with-editor auto-yasnippet ac-ispell auto-complete yasnippet mmm-mode company-statistics company spinner evil-visualstar evil-visual-mark-mode evil-tutor evil-surround evil-mc evil-matchit evil-lisp-state evil-indent-plus evil-iedit-state iedit evil-exchange evil-ediff evil-args evil-anzu anzu evil undo-tree adaptive-wrap ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline smartparens restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox org-plus-contrib org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint indent-guide hydra lv hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-themes helm-swoop helm-projectile projectile pkg-info epl helm-mode-manager helm-make helm-flx helm-descbinds helm-ag google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-unimpaired evil-search-highlight-persist highlight evil-numbers evil-nerd-commenter evil-escape goto-chg eval-sexp-fu elisp-slime-nav dumb-jump f dash s diminish define-word column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed aggressive-indent ace-window ace-link ace-jump-helm-line helm avy helm-core popup async))))
  (custom-set-faces
   ;; custom-set-faces was added by Custom.
   ;; If you edit it by hand, you could mess it up, so be careful.
   ;; Your init file should contain only one such instance.
